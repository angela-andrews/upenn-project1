...
subBtn.on("click", function(event){
    ...
    $.ajax({
        ...
        // url:'https://api.foursquare.com/v2/venues/search?limit=2&client_id=JCLA1HWJ55UOLNG3HWFZ2R1TAN2IM2SFTGW2WEAAXFLVB0TS&client_secret=OYTPQ0BRQGOQUUWWNHPZME3RNVUHCALAXE1Z1OLJZCN0311K&v=20130815&near=Philadelphia' + keyword, //devdummy19101
           url:'https://api.foursquare.com/v2/venues/search?limit=2&client_id=IJ3B0NWBCNRJ0K35TGKP35LF0MLMCDY2OFHJHULPOHOF1BKS&client_secret=PCEHMREMVGPUIBDLGMQYI52W20GVFPYCN5SV3HDOLXBOABZW&v=20130815&near=Philadelphia' + keyword, //devdummy19101
    ...
    for(var j = 0; j<venIdArray.length; j++){
        $.ajax({
            ...
            //  url:'https://api.foursquare.com/v2/venues/' + venIdArray[j] + '?client_id=JCLA1HWJ55UOLNG3HWFZ2R1TAN2IM2SFTGW2WEAAXFLVB0TS&client_secret=OYTPQ0BRQGOQUUWWNHPZME3RNVUHCALAXE1Z1OLJZCN0311K&v=20130815', //devdummy19101
                url:'https://api.foursquare.com/v2/venues/' + venIdArray[j] + '?client_id=IJ3B0NWBCNRJ0K35TGKP35LF0MLMCDY2OFHJHULPOHOF1BKS&client_secret=PCEHMREMVGPUIBDLGMQYI52W20GVFPYCN5SV3HDOLXBOABZW&v=20130815', //devdummy19101
        ...
        var cardBody = $("<div class='card-body bg-white text-center'>");
            var cardTitle = $("<h6 class='card-title'>").text(venDetails.name);
